<template>
  <template v-if="entry">
    ...
    <img
      src="https://mymodernmet.com/wp/wp-content/uploads/2020/02/Landscape-Photographer-of-the-Year-Sander-Grefte.jpg"
      alt="entry-picture"
      class="img-thumbnail"
    />
  </template>
  ...
  methods: {
    ...
    async saveEntry() {
      ...
      if (this.entry.id) {
        ...
        await this.$router.push({ name: "entry", params: { id: name } })
      }
